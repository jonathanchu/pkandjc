...
$.fn.popover.defaults=$.extend({},$.fn.tooltip.defaults,{placement:'right',content:'',template:'<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>'})}(window.jQuery);!function($){"use strict";var Button=function(element,options){this.$element=$(element)
...
e.preventDefault()
$this.typeahead($this.data())})})}(window.jQuery);var App={init:function(){var path=window.location.pathname;var path_a=path.split('/');var mode=path_a[1];switch(mode){case'':window.setTimeout(App.pageHome,100);break;default:}},pageHome:function(){$('ul.nav a').bind('click',function(event){var $anchor=$(this);if($(this).attr('href')=='#home'){$('html, body').animate({scrollTop:0},'slow');return false;}
$('html, body').stop().animate({scrollTop:$($anchor.attr('href')).offset().top},1500,'easeInOutExpo');event.preventDefault();});$('.navbar-bow a').bind('click',function(event){var $anchor=$(this);$('html, body').animate({scrollTop:0},'slow');return false;});$('#mainCarousel').carousel({interval:false});$('#photosCarousel').carousel({interval:false});$('#bridesmaidsCarousel').carousel({interval:false});$('#groomsmenCarousel').carousel({interval:false});},}
