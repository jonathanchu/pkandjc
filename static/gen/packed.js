...
$('html, body').stop().animate({scrollTop:$($anchor.attr('href')).offset().top},1500,'easeInOutExpo');event.preventDefault();});$('#mainCarousel').carousel({interval:false});$('#photosCarousel').carousel({interval:false});$('#bridesmaidsCarousel').carousel({interval:false});$('#groomsmenCarousel').carousel({interval:false});},}
